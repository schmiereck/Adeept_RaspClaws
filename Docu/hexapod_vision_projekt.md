...
## Vision-basierte autonome Navigation mit ROS2

---

## 📋 Projekt-Übersicht

**Ziel:** Hexapod-Roboter mit Kamera ausstatten, der autonom Objekte findet und dorthin navigiert, mit schrittweisem Aufbau von einfacher Objekterkennung bis zu einem selbstlernenden World Model.

**Hardware:**
- Hexapod mit eigener Kinematik (ROS2 Actions)
...
- Optional: TensorRT für Optimierung
