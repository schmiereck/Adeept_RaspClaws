...
def set_servo_smooth(channel, target_pos, steps=0, delay=0):
	"""
...
def dove_Left_I(horizontal, vertical):
	...
	if leftSide_direction:
		...
		target_h = pwm0 - horizontal
	set_servo_smooth(0, target_h, steps=3, delay=0.005)
	...
	if leftSide_height:
		...
		target_v = pwm1 - vertical
	set_servo_smooth(1, target_v, steps=3, delay=0.005)
...
def dove_Left_II(horizontal, vertical):
	...
	if leftSide_direction:
		...
		target_h = pwm2 - horizontal
	set_servo_smooth(2, target_h, steps=3, delay=0.005)
	...
	if leftSide_height:
		...
		target_v = pwm3 - vertical
	set_servo_smooth(3, target_v, steps=3, delay=0.005)
...
def dove_Left_III(horizontal, vertical):
	...
	if leftSide_direction:
		...
		target_h = pwm4 - horizontal
	set_servo_smooth(4, target_h, steps=3, delay=0.005)
	...
	if leftSide_height:
		...
		target_v = pwm5 - vertical
	set_servo_smooth(5, target_v, steps=3, delay=0.005)
...
def dove_Right_I(horizontal, vertical):
	...
	if rightSide_direction:
		...
		target_h = pwm6 - horizontal
	set_servo_smooth(6, target_h, steps=3, delay=0.005)
	...
	if rightSide_height:
		...
		target_v = pwm7 - vertical
	set_servo_smooth(7, target_v, steps=3, delay=0.005)
...
def dove_Right_II(horizontal, vertical):
	...
	if rightSide_direction:
		...
		target_h = pwm8 - horizontal
	set_servo_smooth(8, target_h, steps=3, delay=0.005)
	...
	if rightSide_height:
		...
		target_v = pwm9 - vertical
	set_servo_smooth(9, target_v, steps=3, delay=0.005)
...
def dove_Right_III(horizontal, vertical):
	...
	if rightSide_direction:
		...
		target_h = pwm10 - horizontal
	set_servo_smooth(10, target_h, steps=3, delay=0.005)
	...
	if rightSide_height:
		...
		target_v = pwm11 - vertical
	set_servo_smooth(11, target_v, steps=3, delay=0.005)
